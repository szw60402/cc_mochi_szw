...
|:--|:--:|:--|:--|
| 读取文件 (Reading) | `y` | 编码 Coding | 数码雨 Matrix rain |
| 写入代码 (Writing) | `c` | 书写 Writing | 纸面逐行写字 |
| 编译中 (Compiling) | `v` | 执行 Executing | 脉冲条纹扫描 |
| 编译错误 (Error)   | `2` | 慌乱 Panic | 反白画面 + 冷汗滴 |
| 编译成功 (Success)  | `3` | 骄傲 Proud | ^ ^ 眼 + 星星爆发 |
